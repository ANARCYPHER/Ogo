...
public class TripHistoryCompletActivity extends AppCompatActivity implements GetResult.MyListener, TripAdapter.RecyclerTouchListener {
    ...
    private void getTripe() {
        ...
        try {
            ...
            Call<JsonObject> call = APIClient.getInterface().tripeCompletHistory(bodyRequest);
            GetResult getResult = new GetResult();
            getResult.setMyListener(this);
            getResult.callForLogin(call, "1");
            custPrograssbar.prograssCreate(TripHistoryCompletActivity.this);
...
e.printStackTrace();
    ...
    public void onClickWheelerInfo(OrderHistoryItem item, int position) {
        ...
        startActivity(new Intent(TripHistoryCompletActivity.this, TripeDetailsActivity.class).putExtra("order_id", item.getRideId()));
